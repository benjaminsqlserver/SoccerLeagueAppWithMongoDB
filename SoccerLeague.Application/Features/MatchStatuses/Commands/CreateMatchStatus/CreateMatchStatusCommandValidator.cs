...
{
    public class CreateMatchStatusCommandValidator : AbstractValidator<CreateMatchStatusCommand>
    {
        private readonly IMatchStatusRepository _repository;

        public CreateMatchStatusCommandValidator(IMatchStatusRepository repository)
        {
