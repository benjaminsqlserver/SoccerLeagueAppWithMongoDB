...
namespace SoccerLeague.Application.Features.Roles.Commands.UpdateRole
{
    public class UpdateRoleCommandValidator : AbstractValidator<UpdateRoleCommand>
    {
        ...
        private async Task<bool> BeUniqueRoleName(UpdateRoleCommand command, string name, CancellationToken cancellationToken)
        {
            return !await _repository.RoleNameExistsAsync(name, command.Role.Id);
        }
    }
}
