...
{
    public class CreateSeasonStatusCommandValidator : AbstractValidator<CreateSeasonStatusCommand>
    {
        private readonly ISeasonStatusRepository _repository;

        public CreateSeasonStatusCommandValidator(ISeasonStatusRepository repository)
        {
