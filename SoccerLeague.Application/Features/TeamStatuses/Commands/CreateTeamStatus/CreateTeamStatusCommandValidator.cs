...
{
    public class CreateTeamStatusCommandValidator : AbstractValidator<CreateTeamStatusCommand>
    {
        private readonly ITeamStatusRepository _repository;

        public CreateTeamStatusCommandValidator(ITeamStatusRepository repository)
        {
